...
//We add this to make Address Sanitizer work with libraries that have it turned off. More information here: https://learn.microsoft.com/en-us/cpp/sanitizers/error-container-overflow?view=msvc-170
